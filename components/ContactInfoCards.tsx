...
const contactMethods = [
  ...
  },
  {
    ...
    sub: "India — Visit our studio in the heart of the city.",
    href: "#",
  },
];
      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20 animate-fade-in-up [animation-delay:100ms]">
          {contactMethods.map((method, idx) => (
            <div
              key={idx}
              className="group bg-white p-10 rounded-3xl border-2 border-gray-50 hover:border-black transition-all duration-500 hover:shadow-3xl hover:shadow-black/5 border-green-500 border-1"
            >
              <div className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center text-2xl mb-8 shadow-sm group-hover:bg-black group-hover:text-white transition-colors duration-300">
                {method.icon}
              </div>
